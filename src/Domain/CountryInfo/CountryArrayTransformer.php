...
namespace Iriven\WorldDatasets\Domain\CountryInfo;
...
final class CountryArrayTransformer
{
     ...
     */
    public function toApiArray(CountryInfo $country): array
    {
        return [
     ...
     */
    public function toStorageArray(CountryInfo $country): array
    {
        return [
            $country->alpha2(),
            $country->alpha3(),
     ...
     */
    public function toFlatArray(CountryInfo $country): array
    {
        return [
            'alpha2' => $country->alpha2(),
            'alpha3' => $country->alpha3(),
